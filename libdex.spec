...
Version  : 0.7.0
Release  : 8
URL      : https://gitlab.gnome.org/GNOME/libdex/-/archive/0.7.0/libdex-0.7.0.tar.gz
Source0  : https://gitlab.gnome.org/GNOME/libdex/-/archive/0.7.0/libdex-0.7.0.tar.gz
...
%prep
%setup -q -n libdex-0.7.0
cd %{_builddir}/libdex-0.7.0
pushd ..
cp -a libdex-0.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720100752
