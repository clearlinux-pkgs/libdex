...
Version  : 0.11.0
Release  : 15
URL      : https://gitlab.gnome.org/GNOME/libdex/-/archive/0.11.0/libdex-0.11.0.tar.gz
Source0  : https://gitlab.gnome.org/GNOME/libdex/-/archive/0.11.0/libdex-0.11.0.tar.gz
...
%prep
%setup -q -n libdex-0.11.0
cd %{_builddir}/libdex-0.11.0
pushd ..
cp -a libdex-0.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751292865
...
/usr/include/libdex-1/dex-thread.h
