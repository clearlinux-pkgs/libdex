...
Source0  : https://gitlab.gnome.org/GNOME/libdex/-/archive/0.5.1/libdex-0.5.1.tar.gz
...
%prep
%setup -q -n libdex-0.5.1
cd %{_builddir}/libdex-0.5.1
pushd ..
cp -a libdex-0.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709566690
