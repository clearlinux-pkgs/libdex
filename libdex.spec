...
Source0  : https://gitlab.gnome.org/GNOME/libdex/-/archive/0.9.0/libdex-0.9.0.tar.gz
...
%prep
%setup -q -n libdex-0.9.0
cd %{_builddir}/libdex-0.9.0
pushd ..
cp -a libdex-0.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738017147
